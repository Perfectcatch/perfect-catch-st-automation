...
export async function syncAppointments({ full = false, since = null } = {}) {
  ...
  try {
    ...
    const baseUrl = `${config.serviceTitan.apiBaseUrl}/dispatch/v2/tenant/${tenantId}/appointments`;
    ...
    if (isNew) {
      await client.query(`
        INSERT INTO st_appointments (
          ...
          technician_ids, special_instructions,
      ...
      `, [
        ...
        JSON.stringify(appointment.technicianIds || []),
